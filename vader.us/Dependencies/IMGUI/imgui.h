...
namespace ImGui
{
	...
	extern IMGUI_API void   Render();                                   // ends the Dear ImGui frame, finalize the draw data. You can get call GetDrawData() to obtain it and run your rendering function. (Obsolete: this used to call io.RenderDrawListsFn(). Nowadays, we allow and prefer calling your render function yourself.)
	...
	IMGUI_API bool			BeginTitleBarBackground(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
	IMGUI_API void          End();
	...
	IMGUI_API bool          BeginTitleBar(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginTitleBar(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	...
	IMGUI_API void			PushStyleColor(ImGuiCol idx, ImGuiCol idx2);
	...
	IMGUI_API bool          TitleButton(const char* label, const ImVec2& size = ImVec2(0, 0));    // title button
	...
	IMGUI_API bool          SelectedSubTab(const char* label, const ImVec2& size = ImVec2(0, 0));    // selected sub tab
	IMGUI_API bool          SubTab(const char* label, const ImVec2& size = ImVec2(0, 0));    // sub tab
	...
	IMGUI_API bool			Hotkey(const char* label, int* value, const ImVec2& size);
