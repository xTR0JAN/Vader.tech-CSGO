...
public:
	...
	void store( Player* player ) {
		...
		m_sim_cycle = player->m_AnimOverlay( )[ 11 ].m_cycle;
		m_sim_rate = player->m_AnimOverlay( )[ 11 ].m_playback_rate;

		time_delta = m_sim_time - m_old_sim_time;
