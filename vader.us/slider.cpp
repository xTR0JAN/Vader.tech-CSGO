...
void Slider::draw( ) {
	...
	// draw label.
	if( m_use_label )
		render::menu_shade.string( p.x + LABEL_OFFSET, p.y - 2, { 255, 255, 255, m_parent->m_alpha }, m_label );
	...
	render::gradient1337(p.x + SLIDER_X_OFFSET + 1, p.y + m_offset + 1, m_fill - 2, SLIDER_HEIGHT - 2, color, (255, 255, 255, m_parent->m_alpha));
